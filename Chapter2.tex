...
\item\textbf{User}
User is the end user of the system. Its the person who will go online and get the services. In our system most of the time we refer user as the employee of the company who is accessing the services of the bank.
\item\textbf{Bank}
Bank is the financial institution which provides online financial services to the user. In our system, we refer Nykredit as bank.
\item\textbf{Third party}
A third party or trusted third party is the entity which is neither bank or the user in the system. A third party provides different services to banks or users and hence reducing the burden on them to setup all the infrastructure by themselves. In our system, Signical plays the role of the third party.
\item\textbf{Service}
